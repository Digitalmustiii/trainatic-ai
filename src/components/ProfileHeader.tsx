      ...
      <div className="flex flex-col md:flex-row items-start md:items-center gap-6">
        <div className="relative">
          {user.imageUrl ? (
            ...
            <div className="w-24 h-24 rounded-lg bg-gradient-to-br from-accent/30 to-primary/30 flex items-center justify-center">
        ...
        <div className="flex-1">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-2 mb-2">
            ...
            <div className="flex items-center bg-cyber-terminal-bg backdrop-blur-sm border border-border rounded px-3 py-1">
              ...
              <p className="text-xs font-mono text-accent">USER ACTIVE</p>
            </div>
          </div>
          <div className="h-px w-full bg-gradient-to-r from-accent via-primary to-accent opacity-50 my-2"></div>
